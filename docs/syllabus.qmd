...
You may (indeed, are encourged to) stay with the same topic and same ideas, to the extent that they are applicable. You may often keep a significant amount of text from one version to the other, as long as you are revising sufficiently to (1) address the new audience and policymaking authority and (2) incorporate feedback on your prior memo.  See the [memo assignment guide](https://judgelord.github.io/PP510/memos.html).
...
Academic dishonesty is broadly defined as submitting work that is not your own without attribution. This is not acceptable in any academic course. If you submit written work that is not your own without attribution, you will receive a failing grade for the course and be reported to the University.
