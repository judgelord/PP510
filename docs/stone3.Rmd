...
This map, from a very effective policy memo, makes an argument by putting maps highlighting two different things (housing code violations and housing cost relative to income) side by side, thus linking them visually: 
...
What symbols are used to frame an issue as each story? 
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Thanks for joining us, east/central. West, you’re next! And, we’re back Monday night for a special edition of <a href="https://twitter.com/hashtag/ABC2020?src=hash&amp;ref_src=twsrc%5Etfw">#ABC2020</a> anchored by <a href="https://twitter.com/DavidMuir?ref_src=twsrc%5Etfw">@DavidMuir</a>, reporting on the extraordinary efforts by healthcare workers on the frontlines and the latest developments on the coronavirus pandemic. <a href="https://t.co/GzG87mjl3e">pic.twitter.com/GzG87mjl3e</a></p>&mdash; 20/20 (@ABC2020) <a href="https://twitter.com/ABC2020/status/1243735059355652096?ref_src=twsrc%5Etfw">March 28, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

---

**Decline:**

> "In the beginning, things were pretty good. But they got worse. In fact, right now, they are nearly intolerable. Something must be done." - Stone, page 160
...
### Stories of power: helplessness and control

> What all these power stories have in common is their assertion that there is a choice. - Stone, page 168
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vgqG3ITMv1Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---

**Blame-the-victim stories:** (I might have labeled these "personal responsibility stories" or "irresponsible victim stories")
...
> **Horror stories** generate fear that may temporarily suspend our inclination to ask factual and analytical questions. - Stone, page 169
...
> In a culture where the common understanding of fairness is "treating like things alike," to claim a likeness is also to posit an interpretation of equity and to demand equal treatment. - Stone, page 171

---

Metaphors are powerful tools to affect policy. Thus we may see them as a rhetorical resource.
...
This can unite people with different material interests (see "Women unite" under Interests below).
...
### Policymakers use ambiguity to do two things at once.
...
Why do the White people in the audience look surprised and laugh uncomfortably when Charles points out the bi-partisan agreement on US policy toward Native American land and sovereignty? 
...
> The ambiguity of symbols helps transform individual strivings into collective decisions. Symbols can help unit people around ideals because they exist outside the realm of the practical and the real. Symbols allow coalitions to form when pure material interests would divide people. - Stone, page 182
...
One common way to define a problem is to measure it. Bardach told us that problems are best stated as "too much" or "too little" of something. Numbers allow precise definitions of too much or too little.

Yet, there are many possible ways to measure something, and the choice among them depends on one's purpose for measuring.

???

What is the current unemployment rate? (This depends on who counts as unemployed. Defining unemployment is both *descriptive* and implicitly *prescriptive*.)
...
What do some economists mean when they say there is a "natural" rate of unemployment?

Is there a "natural" rate of homelessness?

What does the language of "nature/natural" imply about our ability to solve problems in the story one is telling? Is it a story of helplessness or control?
...
- debates that appear to be about the tally are usually about the categories (recall the [Cost Benefit Analysis of Mercury Rule](https://judgelord.github.io/PS272/stone2.html#is_regulating_mercury_efficient))


### Numbers are Metaphors

> To categorize in counting or to analogize in metaphors is to select on a feature of something, assert a likeness on the basis of that feature, and ignore all other features. - Stone, page 185

Who or what is counted can be challenged for **wrongful inclusion**. Who or what not counted can be challenged for **wrongful exclusion**.
...
> Sometimes numbers represent members of what we might call "natural communities" or "primary groups," people who actually interact regardless of whether they are counted. The population of a village, size of a family, or size of a school are examples. Other numbers represent artificial or statistical communities; they lump together people who have no relationship other than the shared characteristic that determined the count, such as age, occupation, or sexual orientation. 

> Social movement leaders must convert statistical members (ones who share important characteristics but have no real relationship with the group) into natural members (ones who actually participate)...counting can be a deliberate tool for political mobilization. - Stone, page 194
...
This map highlights hazardous chemical facilities regulated under the Risk Management Plan (RMP) program (just one *measure* of environmental risk). It also highlights race (*as counted by* the Census): 
...
For example, if we only considered the energy density of fuel sources (versus cost or safety), we might draft policy to build more nuclear power plants:
...
In doing so, numbers sometimes mask the political nature of a decision. For example, numbers suggest that safety can be defined though science (but recall the complexity and subjective nature of "Security"). 
...
> People change their behavior in response to being measured. Understanding reactivity is so important in policy analysis because, unlike deliberate falsification of numbers, it is an inextricable feature of social measurement. - Stone, page 200, citing ["The Third Level of U.S. Welfare Reform"](https://www.tandfonline.com/doi/abs/10.1080/13621025.2010.522363?journalCode=ccst20) by Schram et al.
...
By counting people as part of a group, a policy may induce them to act as a group (whereby policy that creates a **statistical community** leads to the formation of a **natural (social) community**). Group theories of politics (e.g., **pluralism**) tell us to expect these groups to then advocate for resources, privileges, or protection in future policy processes.

???

If the Department of Justice Antitrust Division measures market concentration to decide whether to permit corporate mergers and acquisitions, how do you think this might affect how large companies lobby regarding the definition of the "market" they are in? 

![](figs/market-concentration.jpg)

![](figs/market-concentration-amazon.jpg)
...
> Every number, therefore, is an assertion about similarities and differences. No number is innocent, for it is impossible to count without making judgments about categorization. - Stone, page 188

Know: Numerical Strategies in Problem Definition (page 203)
...
I often say that issue analysis in policy memos must identify "root causes" that can be targeted by policy. Stone's critique demands that we see the *prescriptive* power in causal analysis. Like numbers, causes highlight some aspects of a problem and ignore others. Causal chains are stories that define problems and assign blame.

> We look for causes not only to understand how the world works but to *assign responsibility* for problems. - Stone, page 206
...
Perhaps this question is unfair because rhetoric often uses the cultural authority of science and numbers, and, conversely, science must be communicated in language that has been shaped by political rhetoric. This does not mean that science worthless. On the contrary, political rhetoric uses science whenever possible, precisely because of the broad trust in scientists to provide the most reliable answers to questions. This trust exists for good reasons. 

## Causal stories as problem definition

> The natural world is the realm of fate...The social world is the realm of control and intent...In everyday discourse, as Erving Goffman points out, we use the term causality to refer to both "the blind effect of nature and intended effect of man, the first seen as an infinitely extended causal chain of caused and causing effects and the second something that somehow begins with a mental decision." - Stone, page 207, citing Goffman, "[Frame Analysis](https://www.nytimes.com/1975/02/16/archives/frame-analysis.html)," page 23 

Know: Types of Causal Theories (page 208)
...
Stone cites the case of *Grinshaw v. Ford Motor Co.*, where the court held that

> Ford's business decision to trade safety for cost was "conscious disregard for the probability that its conduct will result in injury to others."

<iframe width="560" height="315" src="https://www.youtube.com/embed/gKQ-U-rnLdo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

Actual Ford Pinto crash test:

<iframe width="560" height="315" src="https://www.youtube.com/embed/lgOxWPGsJNY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---

### Conspiracy stories frame problems as having intentional causes

<iframe src="https://www.npr.org/player/embed/803766743/803869550" width="100%" height="290" frameborder="0" scrolling="no" title="NPR embedded audio player"></iframe>
...
For example, climate change has moved from **mechanical cause** in the Holocene to **intentional cause** in the Anthropocene. (perhaps a *conspiracy* if one is explicitly for more ambitious climate policy, or a *calculated risk* if one is explicitly opposed to such policy--both explicitly political positions. Or, for people implicitly against climate policy, but who want to strategically frame the issue out of political discourse, perhaps the climate is such a **complex system** that it is impossible to make policy, and thus we should not try--an anti-political position.)
...
> The idea that natural phenomena are "uncaused" and have no relation to human decision making is outmoded. - Stone, page 218

???

Are pandemics natural disasters? Into which box(es) in Table 9.1 has the COVID-19 pandemic been framed?
...
The podcast, [Death by a Thousand Cuts](https://scholars.org/podcast/death-thousand-cuts) talked about "Administrative Evil" in Flint, Michigan, applying the philosopher Hannah Arendt's concept of "the Banality of Evil" to agency decisions. 

The language of "evil" is an issue frame that evokes certain social obligations--e.g. to not poison people with lead or to not put people at risk when they fly, but policy often permits some level of toxins or some level of risk; when does it cross the threshold to unacceptable? These are very difficult and unavoidable policy questions that, Stone would say, science can inform but not answer these questions. For what kinds of harms should elected officials be liable? For what kinds of harms should bureaucrats be held liable?  For what kinds of harms should the organizations be held liable? For what kinds of harms should employees be liable? For what kinds of harms should business owners be liable?

> "I was just following orders" is the classic defense of low-level bureaucrats and soldiers - Stone, Page 213
...
If Eichmann's work, as a bureaucrat, is seen as a mechanical process of following orders, then he is not a policy **actor** and thus not responsible for deaths (and ** inadvertent cause**, not an **intentional cause**). How might we draw lines between people who are simply following orders and thus blameless and those who act consciously, and are thus responsible?
...
Sometimes, historical and institutional causes can be used to avoid blam because they imply that outcomes are not the result of **intentional** actions in the present. 

However, they can also be used to transform **conditions** into **problems** that require a remedy. For example, if some inequality is the result of historical or institutional disadvantage, then it moves from the realm of "just the way things are" to unintended consequences (**inadvertent cause**) or accepted consequences (similar to calculated risk, an **intentional cause**), opening the door for advocates to demand a solution to the historical or institutional problem.
...
> Bringing a condition under human control often poses a challenge to old hierarchies of wealth, privilege, or status. - Stone, page 224

> Struggles over causal definitions of problems are contests over basic structures of social organization and allocations of power. - Stone, page 225

> The fight is about locating moral responsibility and real economic costs on a chain of possible causes. - Stone, page 226

## The legitimacy of causal claims

> The political success of causal theories is also influenced by two powerful institutions for determining cause and legitimizing claims about harms: law and science. - Stone, page 224 
...
An effective policy memo analyzes the political terrain (to use that metaphor again) of existing stakeholder groups and anticipates how stakeholder interests that might be mobilized by policy, *even interest groups that are not yet mobilized or do not yet exist* because *policy proposals create interests*.
...
> Collective action in politics is more like a sports competition than a bargain hunt. One plays to win, and winning gives the game its direction and structure, but one place even more just to play, and the greater satisfaction comes from being in the game. Seen in this light, the costs of collective action such as the time and effort *are* its benefits. - Stone, page 237, citing Hirshman, [Shifting involvement: Private Interest and Public Action](https://books.google.com/books?id=uPZJDAAAQBAJ&printsec=frontcover&source=gbs_atb#v=onepage&q&f=false)
...
(page 239 in Stone, page 267 in Birkland ( [Birkland slide here](https://judgelord.github.io/PS272/birkland#84) ))
...
> In practice, the two types of unequal contests [clintele politics and entrepreneurial politics] are really only one, depending on whether we look at the issue from the vantage point of the proposed change or the status quo. - Stone, page 240

???

To what extent to the characteristics of issues or policies shape the resulting politics (as Wilson argues)?
...
Stone claims that "Programs don't themselves have inherent distributions of costs and benefits. Rather, political actors strategically represent programs as contests between different types of costs and benefits." (Stone, page 243) To me, the second sentence seems much more plausible than the first. 

No doubt, both would likely concede some ground, but it is worth considering the extent to which the structure of policy tools shape politics versus their perception. 
...
> In American political culture, where the government is viewed as properly a referee among interests rather than a strong power itself, the most important source of outside help is government. Ironically, then, portraying one's own side as weaker becomes strategically useful in order to attract both government support and broad support from as-yet-uninvolved groups who share your values. - Stone, page 245
...
## Policy reasoning example: COVID-19

Suppose that scientists estimate that COVID-19 has a mortality rate of 2% and will infect 50% of UW-Madison's 40,000 students, meaning that 600 UW-Madison students are expected to die. The Wisconsin Department of Health Services is deciding between two vaccination programs and can choose only one:

- Program A would use a conventional vaccine that can be counted on to save 200 people.
- Program B would use an experimental vaccine that has a 1/3 chance of saving all 600 people and a 2/3 chance of saving no one.
...
Now suppose the Wisconsin Department of Health Services is considering two other possible vaccination programs:

- Program C would use a conventional vaccine that we know from experience will result in the death of 400 people
- Program D would use an experimental vaccine that would offer a 1/3 chance no one would die and a 2/3 chance that all 600 students would die.

Which would you choose? 

--

Changing labels ("lives saved" vs. "deaths") can turn most people from *risk-tolerant* to *risk-averse*. This is the power of **issue framing**.


From *[The Psychology of Prefrences](https://www.jstor.org/stable/24966506?seq=1#metadata_info_tab_contents)* by Daniel Kahneman and Amos Tversky

---

**Issue framing**: The process of focusing attention on a particular slice of an extended causal chain is called issue framing.
...
In this example, the consequence (or at least its **expected value**--the expected number of deaths) is exactly the same in all cases, but some of these policies seem more appropriate than others. This suggests that choices among policy options depend on more than their expected outcomes.

???

When should framing effects be considered errors in judgement? When should they be considered biases?

For example, public opinion filps depending on whether a policy is characterized as an "expansion of government *power*" or an an "expansion of government *spending*" (Gallup, 2009). If a policy was characterized using the word "welfare," support dropped by 40%. ([Smith, 1987](https://www.jstor.org/stable/2749059#metadata_info_tab_contents))
...
> Whether you are wearing your citizen hat or your analyst hat, be on the lookout for **Hobson's choices**. Whenever you are presented with an either-or choice, you should be tiped off to a trap. You can disengage it by imagining different alternatives other than thos presented (there are always more), and by giving new attributes to the ones presented. 

Policymakers are smart and will often see through false choices (even my friend's 2 year old does not always fall for the "eat this or eat that" trick). This is why it is important to compare good options--that is, options your reader will agree are some of the best things they might do. If the options you present apear to bias the decision, they are not going to take your analysis seriously. But, of coures, the options you choose will always affect the decision! The trick is to present options that don't make your anlalysis seem pre-judged or tilted to a particular outcome. 
...
> Evaluating different options should include how the options are and could be *characterized and what they reptresetn--or might represent--symbollically, as well as practically. - Stone, page 261

Costs often rely on prices in markets as currently structured, rather than how the market might price things after reform. 

> Instead of taking prices as a given, policy reformers should analyze the forces that create prices and sometimes put their efforts into changing prices by chagning the power relations that set them. - Stone, page 262

---

- Analyists force themseves to measure all the consequences in the same terms.
- This pressures analysists to ignore what they can't count.

> Depending on the proposal, **intangible cost might be accidental deaths, adverse health effects, damaged political reputations, urban decline, or loss of a wilderness area. Intangable benefits might be psychological secutrity from saftety meausres, enhanced political credibility, urban revitalization, species diversity, or spritual nurishment. - Stone, age 261

Recall the [Mercury Rule example](https://judgelord.github.io/PS272/stone2.html#is_regulating_mercury_efficient). 

> The clever analyst can throw the sections on way by including enought negative consequenes to outweitght the posititive ones, or throw it the other way by including more positve consequences...If you undersant how malleable cost-benefit anlsysi canbe, you can more effectively critique other anslysis and construct analysis that will support your political goals. - Stone Page 264
...
Is the aim of the government to "produce the greatest good for the greatest number for the longest period of time?"
...
- [The Forging of Bureaucratic Autonomy: Reputations, Networks, and Policy Innovation in Executive Agencies, 1862-1928](https://books.google.com/books?id=_yvIAoYV--UC&printsec=frontcover&source=gbs_atb#v=onepage&q&f=false) by Daniel Carpenter.  

![](figs/carpenter.jpg)

---

- [After Nature](https://books.google.com/books?id=q5xOrgEACAAJ&printsec=frontcover&source=gbs_atb#v=onepage&q&f=false) by Jedediah Purdy

<iframe width="560" height="315" src="https://www.youtube.com/embed/Kz1B84-3qdw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

---

More reading on decisions for the Anthropocene:

- [Home is Always Worth It](https://medium.com/@maryheglar/home-is-always-worth-it-d2821634dcd9) by Mary Annaïse Heglar

---

- [After Geoengineering: Climate Tragedy, Repair, and Restoration](https://books.google.com/books?id=0TOGDwAAQBAJ&printsec=frontcover#v=onepage&q&f=false) by Holly Jean Buck

<iframe width="560" height="315" src="https://www.youtube.com/embed/ldYq11u1qwU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
