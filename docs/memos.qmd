...
2. **policy analysis** comparing policy options on criteria suggested by your issue analysis.  
...
Your second memo must be addressed to an state or tribal executive-branch official in Michigan. Typically, this will be the Chair of the Michigan Public Service Commission or the Director of the Michigan Department of Environment, Great Lakes & Energy.
...
Either type of memo is fine. Which is better largely depends on where the policymaker is at. Have they already committed to a new policy direction and need help figuring out how to implement it? Or are they struggling with which direction to go, and once they make that choice, how to do it is more straightforward? 
