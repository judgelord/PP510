...
🚧 [Updated `r Sys.Date() |> format("%B %d, %Y")`](https://github.com/judgelord/PP510/commits/main/docs/syllabus-fall-2024.html) 🚧 
...
> "Spend a lot of time in O.H. with both Devin and the GSI. It really helps."

> "Pick a topic that would be relevant, generally, for all three of your memos so you can utilize the material from the last one for future memos (especially regarding research)."

> "Go to office hours early if you are struggling to find a memo topic."

>  "Have faith in your ability to learn about and contribute to the conversation around technical policy issues!"

> "Go to office hours for clearer understanding of how to write memo."

> "Get started on memos early! The research will likely take much longer than the actual writing. Follow the template closely and consult examples."

> "Go to office hours for your memos (Devin's and the GSI's)! It is a really helpful way to get specific feedback."

> "Get started on the memos early, go to office hours to talk through ideas, and follow the calendar!"
...
> [Short Circuiting Policy](https://academic.oup.com/book/32159) by Leah Stokes
...
You will not receive participation points for classes where are on a screen without permission. 
...
#### Participation/discussion posts to Canvas are <mark>due by 5 p.m. every Monday</mark>
