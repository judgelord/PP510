...
You should focus your opening remarks on the part of your work this semester that you feel adds the most value. 

## Reflection and peer critique 

For every roundtable in which you will not be presenting, you will be assigned a
person to critique (5 total). Each should be three paragraphs (about half a page, no more than one page) addressing (1) strengths,  (2) opportunities for improvement, and (3) connections to things we studied in this class, especially the Bardach, Blackhawk, Carpenter, Dwidar, Leech, Seifter, Stone, Woodly, and Weimer and Vining. 

Submit each critique as a separate file to Canvas by the next class session WITHOUT YOUR
...
You do not need to talk about all of your options. Talk about whatever you think is your most important contribution. That could be helpful research you found and its implications for Michigan. It could be comparative analysis of just two of your options. It could be a policy recommendation and implementation details. It could be research related to framing a policy proposal.
...
The class, somewhat playing the part of committee members, will ask additional questions. Again, responses should be concise. 
...
5. Dress the part. Wearing nicer clothes will help you feel more confident and will help you be taken more seriously.
