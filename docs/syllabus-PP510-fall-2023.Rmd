...
Credit hours will be earned by attending two classes of $1.3\bar{3}$ hours each, reading and preparing written work outside of class for 6 to 9 hours per week, round table presentations, one issues memo, three policy memos, one talking points memo, and five roudtable critiques.  
