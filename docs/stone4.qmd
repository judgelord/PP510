...
*Johnson v. M’Intosh* was also discussed in this [Ted Talk on Indian Law](https://judgelord.github.io/PS272/stone3.html#policymakers_use_ambiguity_to_do_two_things_at_once).
...
## {background-image="https://upload.wikimedia.org/wikipedia/commons/3/3d/The_End_Book.png" background-size="contain" background-opacity=".1}
