...
![]("https://academic.oup.com/view-large/figure/422619563/biad080fig1.jpg")
...
Suppose that scientists estimate that COVID-24 has a mortality rate of 2% and will infect 50% of U-M's 40,000 students, meaning that 600 U-M students are expected to die. The Michigan Department of Health & Human Services-M is deciding between two vaccination programs and can choose only one:
...
Now, suppose the Michigan Department of Health & Human Services-M is considering two other possible vaccination programs:
...
Changing labels ("lives saved" vs. "deaths") can turn most people from *risk-tolerant* to *risk-averse*.  (See *[The Psychology of Prefrences](https://www.jstor.org/stable/24966506?seq=1#metadata_info_tab_contents)* by Daniel Kahneman and Amos Tversky.)
