...
## {background-image="figs/isthmus.png" background-size="contain"}
...
This can unite people with different material interests.
...
> The ambiguity of symbols helps transform individual strivings into collective decisions. Symbols can help unit people around ideals because they exist outside the realm of the practical and the real. Symbols allow coalitions to form when pure material interests would divide people. - Stone, p. 182
...
> To categorize in counting or to analogize in metaphors is to select on a feature of something, assert a likeness on the basis of that feature, and ignore all other features. - Stone, p. 185
...
Know: Numerical Strategies in Problem Definition (p. 203)
...
Know: Types of Causal Theories (p. 208)
...
> The political success of causal theories is also influenced by two powerful institutions for determining cause and legitimizing claims about harms: law and science. - Stone, p. 224 
...
(p. 239 in Stone, p. 267 in Birkland ( [Birkland slide here](https://judgelord.github.io/PS272/birkland#84) ))
...
Stone claims that "Programs don't themselves have inherent distributions of costs and benefits. Rather, political actors strategically represent programs as contests between different types of costs and benefits." (Stone, p. 243) To me, the second sentence seems much more plausible than the first. 
...
> In American political culture, where the government is viewed as properly a referee among interests rather than a strong power itself, the most important source of outside help is government. Ironically, then, portraying one's own side as weaker becomes strategically useful in order to attract both government support and broad support from as-yet-uninvolved groups who share your values. - Stone, p. 245
...
> Evaluating different options should include how the options are and could be *characterized and what they reptresetn--or might represent--symbollically, as well as practically. - Stone, p. 261

Costs often rely on prices in markets as currently structured, rather than how the market might price things after reform. 

> Instead of taking prices as a given, policy reformers should analyze the forces that create prices and sometimes put their efforts into changing prices by chagning the power relations that set them. - Stone, p. 262
...
> The clever analyst can throw the decision one way by including enought negative consequenes to outweitght the posititive ones, or throw it the other way by including more positve consequences...If you undersand how malleable cost-benefit analysis can be, you can more effectively critique other anslyses and construct analysis that will support your political goals. - Stone p. 264
