...
After a mere 6 years, the clean energy industry in Texas could not rival the 100-year-old fossil fuel lobby.
...
- transitioning to wind has cost
...
- People won't instal rooftop solar if it does not pay and therefore few customers exist to incentives companies to offer net metering plans.


## Retrenchment (i.e., unmaking policy)  

- 2007 law allowed large energy consumers to opt out of the RPS
...
- by 2011 polarization on clean energy at the stae and federal level turned most Republicans into opponents
