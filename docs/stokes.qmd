...
Electric utilities “used their privileged position to rollback clean energy laws” (Stokes, p. 107).
...
> What kind of regulatory policies need to be enacted at the local/state/federal level to change the way utilities behave? 
